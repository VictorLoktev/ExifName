...
namespace ExifName
{
    ...
    public class CliOptionRename
    {
        ...
        [Option("min", Default = "2004-03-01", Required = false, HelpText = "Минимальная допустимая дата в формате ГГГГ-ММ-ДД, по умолчанию - 2004-03-01")]
        ...
        [Option("max", Default = "tomorrow", Required = false, HelpText = "Минимальная допустимая дата в формате ГГГГ-ММ-ДД, по умолчанию - завтра")]
